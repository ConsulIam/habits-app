...
export function HabitDay({ defaultCompleted = 0, amount = 0, date }: HabitDayProps) {
  ...
  function handleCompletedChanged(completed: number) { // função para indicar saber que o hábito mudou
  ...
  return (
    ...
    <Popover.Portal>
      <Popover.Content className="min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col">
        ...
        {/* date={date} passa a data ao componente HabitsList, onCompletedChanged passa a função também ao HabitList */}
